...
// Convenience wrapper used by the dashboard's fallback "complete your
// profile" card, for anyone who signs in without going through enroll.html.
async function saveProfileName(name) {
  return saveProfile({ full_name: name });
}
